...
class employeeClass:
    def __init__(self,root):
        ...
        bl_email=Label(self.root,text="Email",font=("goudy old style",15),bg="white").place(x=50,y=230)
        ...
        btn_save=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="black",cursor="hand2").place(x=500,y=305,width=110,height=28)        
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="black",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=28)  
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This Employee ID already, try different",parent=self.root)
                else:
