...
class IMS:
    def __init__(self,root):
        ...
        #+++++++++left menu===========
        self.MenuLogo=Image.open("images/as.png")
        ...
        self.icon_side=PhotoImage(file="images/right.png")
        ...
        btn_generate_bill=Button(LeftMenu,text="Generate Bill",command=self.billing,image=self.icon_side,compound=LEFT,padx=0,anchor="w",font=("times new roman",19,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        #====footer====
        lbl_footer=Label(self.root,text="IMS-Inventory Management System\nFor any Technical issue contact: Ajinkya Shama-9326318381 Rutuja Jadhav-7083182109 Pooja Jamalpure-9673440417",font=("times new roman",13,"bold"),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_catagory.config(text=f"Total Categorys\n[ {str(len(category))} ]")
