...
class productClass:
    def __init__(self,root):
        ...
        txt_quntity=Entry(product_frame,textvariable=self.var_qunt,font=("goudy old style",15),bg="lightyellow").place(x=150,y=260,width=200)
        
        cmb_status=ttk.Combobox(product_frame,textvariable=self.var_status,values=("Active","Inactive"),state='readonly',justify=CENTER,font=("goudy old style",15))
        cmb_status.place(x=150,y=310,width=200)
        cmb_status.current(0)

        btn_save=Button(product_frame,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="black",cursor="hand2").place(x=10,y=400,width=100,height=40)        
        ...
        btn_clear=Button(product_frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="black",fg="white",cursor="hand2").place(x=340,y=400,width=100,height=40)  
        ...
        btn_search=Button(searchFrame,command=self.search,text="Search",font=("goudy old style",15),bg="#4caf50",fg="black",cursor="hand2").place(x=410,y=9,width=150,height=30)
        ...
        self.ProductTable=ttk.Treeview(prod_frame,columns=("pid","Supplier","Category","name","price","quantity","status"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
