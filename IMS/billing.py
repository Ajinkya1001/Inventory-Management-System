...
class BillClass:
    def __init__(self,root):
        ...
        self.chk_print=0
        #========title=======
        self.icon_title=PhotoImage(file="images/Ajin.png")
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        btn_logout=Button(self.root,text="Logout",command=self.logout1,font=("times new roman",15,"bold"),bg="yellow",cursor="hand2").place(x=1350,y=10,height=50,width=150)
         #======clock=======
        ...
        ptitle1=Label(productFrame2,text="Search Product | By Name",font=("goudy old style",15,"bold"),bg="white",fg="green").place(x=2,y=5)
        ...
        btn_seach=Button(productFrame2,text="Search",command=self.search,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=285,y=45,width=100,height=25)
        ...
        ctitle=Label(customerFrame,text="Customer Details",font=("goudy old style",15,"bold"),bg="lightgray",fg="black").pack(side=TOP,fill=X)
        ...
        self.carttitle=Label(cart_Frame,text="Cart \t Total Products: [0]",font=("goudy old style",15,"bold"),bg="lightgray",fg="black")
        ...
        txt_p_qtye=Entry(Add_cart_Frame,textvariable=self.var_qty,font=("times new roman",15),bg="lightyellow").place(x=390,y=35,width=120,height=22)
        self.lbl_instock=Label(Add_cart_Frame,text="In Stock",font=("times new roman",15),bg="white")
        self.lbl_instock.place(x=5,y=70)
        btn_clear_cart=Button(Add_cart_Frame,text="Clear",command=self.clear_cart,font=("times new roman",15),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30) 
        btn_add_cart=Button(Add_cart_Frame,text="Add | Update Cart",command=self.add_update_cart,font=("times new roman",15),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)
       
        billFrame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        billFrame.place(x=953,y=110,width=570,height=410)
        ptitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="red",fg="white").pack(side=TOP,fill=X)
        ...
        billMenuFrame.place(x=953,y=520,width=570,height=140)
        ...
        self.lbl_net_pay.place(x=386,y=5,width=175,height=70)
        btn_print=Button(billMenuFrame,text='Print',command=self.print_bill,cursor='hand2',font=('goudy old style',15,'bold'),bg="black",fg="white")
        ...
        btn_clear_all.place(x=194,y=80,width=190,height=50)
        ...
        btn_generate.place(x=386,y=80,width=175,height=50)

        footer=Label(self.root,text="IMS-Inventory Management System | Developed By Ajinkya, Rutuja and Pooja\nFor Any Technical Issue please Contact...",font=("times new roman",33),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            for row in self.cart_list:
                ...
                index_+=1
            if present=='yes':
                op=messagebox.askyesno('confirm',"Product already present\nDo you wantto update| Remove from the Card list",parent=self.root)
                if op==True:
    ...
    def bill_middle(self):
        ...
        try:
            for row in self.cart_list:
                ...
                price=str(price)
                self.txt_bill_area.insert('10.80',"\n"+name+"\t\t\t"+row[3]+"\tRs."+price)
